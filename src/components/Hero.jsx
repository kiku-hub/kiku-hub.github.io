...
const MobileHero = ({ children, backgroundStyle }) => (
  <section 
    className={`relative w-full h-screen mx-auto overflow-hidden`}
    role="banner"
    aria-label="Hero Section - Mobile"
  >
    {children}
  </section>
);

const DesktopHero = ({ children, backgroundStyle }) => (
  <section 
    className={`relative w-full h-screen mx-auto overflow-hidden`}
    role="banner"
...
const Hero = () => {
  ...
  return isMobile ? 
    <MobileHero backgroundStyle={backgroundStyle}>{heroContent}</MobileHero> : 
    <DesktopHero backgroundStyle={backgroundStyle}>{heroContent}</DesktopHero>;
};
